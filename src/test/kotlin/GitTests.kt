...
//        yarn.switchToBranch(branchName, force = true)
...
//        yarn.getOrCloneGit().switchToBranch("master", force = true) { "refs/heads/master" }
//        yarn.deleteBranch("foofo")
//    }
//
//    @Test
//    fun `Can switch with upstream branch as base`() {
//        yarn.getOrCloneGit().switchToBranch("testUpstream2", force = true) { "upstream/19w45b" }
//    }
//}